        ...
        <form method="POST" action="/config">
            <div class="grid">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="left_turn_ms" name="left_turn_ms" min="100" max="5000" step="50" required>
                    <span class="unit">毫秒</span>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="right_turn_ms" name="right_turn_ms" min="100" max="5000" step="50" required>
                    <span class="unit">毫秒</span>
