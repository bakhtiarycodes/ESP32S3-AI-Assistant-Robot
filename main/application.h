...
public:
    ...
    struct MotorActionConfig {
        ...
        int left_turn_duration_ms = 5000;
        int right_turn_duration_ms = 5000;
        int spin_duration_ms = 2500;
        int dance_duration_ms = 1500;
        int quick_forward_duration_ms = 10000;
        int quick_backward_duration_ms = 10000;
...
private:
    ...
    std::atomic<uint32_t> motor_action_generation_{0};
